...
describe("Pictomania Game Logic", () => {
  ...
  describe("Round Management", () => {
    ...
    it("should NOT reveal guess result immediately", () => {
        ...
        expect(socket.emit).not.toHaveBeenCalledWith("toast", expect.objectContaining({
    ...
    it("should Auto-Finish round when last player completes guessing", () => {
        ...
        (room.players[2] as any).myGuesses = [
            { targetPlayerId: "p1", symbol: "circle", number: 2 }
        ];
  ...
  describe("Scoring Logic", () => {
    it("should calculate scores correctly", () => {
      ...
      // Mock data setup
      (room.players[0] as any).symbolCard = "star"; (room.players[0] as any).numberCard = 1;
      (room.players[1] as any).symbolCard = "star"; (room.players[1] as any).numberCard = 2;
      (room.players[2] as any).symbolCard = "star"; (room.players[2] as any).numberCard = 3;
