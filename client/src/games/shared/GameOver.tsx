      ...
      {onBackToLobby && (
        <div className="mt-auto pt-4 border-top">
          <Button
            ...
            className="w-100 rounded-pill py-3 shadow-sm d-flex align-items-center justify-content-center gap-2 mb-3"
    ...
    <div className="d-flex flex-column gap-4">
      <Card className="border-0 shadow-lg rounded-4 overflow-hidden text-center bg-white p-5">
        ...
        <div className="d-inline-flex align-items-center justify-content-center bg-light rounded-pill px-5 py-3 border shadow-inner">
          ...
          <span className="text-dark fw-black display-6" style={{ color: config.color }}>
            {topPlayer?.score}
          </span>
        </div>
      </Card>
