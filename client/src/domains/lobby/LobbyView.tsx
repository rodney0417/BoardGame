...
const LobbyView: React.FC<LobbyViewProps> = ({
  ...
  const sidebarContent = (
    <div className="d-flex flex-row flex-md-column gap-2 gap-md-3 align-items-stretch">
      <style>
        {`
        ...
        <Card.Body className="p-2 p-md-3 p-xl-4 d-flex flex-column justify-content-center h-100">
          <div className="d-flex align-items-center gap-2 mb-2 mb-md-4">
            ...
            <div className="overflow-hidden">
              <h6 className="fw-bold m-0 d-md-none text-truncate" style={{ fontSize: '1rem' }}>
                遊戲大廳
              </h6>
  ...
  const mainContent = (
    <div>
      {roomList.length === 0 ? (
        ...
        <Row className="g-3">
          {roomList.map((r) => {
            const game = GAME_CONFIG[r.gameType as GameType] || {
              icon: '🎮',
              name: r.gameName,
              color: '#6c757d',
                  ...
                  <Card.Body className="p-3 d-flex align-items-center gap-3">
                    ...
                    <div className="flex-grow-1 overflow-hidden">
                      <div className="d-flex justify-content-between align-items-start mb-1">
                        ...
                        {r.ownerName && (
                          <span className="badge bg-light text-secondary fw-normal small">
                            {r.ownerName}
                          </span>
                        )}
                      </div>
                      <div className="d-flex align-items-center gap-2">
                        <span
                          className={`badge rounded-pill ${r.phase === 'playing' ? 'bg-secondary' : 'bg-success'} fw-normal`}
                        >
  ...
  return (
    <>
      <GameLayout sidebar={sidebarContent} main={mainContent} reverseMobile={true} />
      ...
      >
        <Modal.Body className="p-0">
          ...
          >
            <div className="display-1 mb-2 position-relative" style={{ zIndex: 2 }}>
              {GAME_CONFIG[selectedGame].icon}
            </div>
            <h4 className="fw-bold mb-0 position-relative" style={{ color: '#4a4a4a', zIndex: 2 }}>
              創建房間
            </h4>
            <div
                ...
                return (
                  <div
                    ...
                    style={{
                      ...
                      border:
                        selectedGame === key ? `2px solid ${info.color}` : '2px solid transparent',
                      cursor: 'pointer',
                    }}
